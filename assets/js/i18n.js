  ...
  const LANGS = {
    'zh-Hant': {
      ...
      dict: {
        ...
        'hero.cta.register': '前往 Microsoft Reactor 報名 →',
        ...
        'reg.cta1': '前往 Microsoft Reactor 報名 ↗',
        'reg.cta2': '查看 Microsoft Reactor 活動頁面',
        'reg.note': '報名平台:Microsoft Reactor (developer.microsoft.com) · 座位有限,依報名先後順序',
        'reg.official.badge': '官方 Microsoft Reactor 活動',
        'reg.official.link': '查看 Reactor 活動頁面 (event #27246) ↗',
    ...
    'en': {
      ...
      dict: {
        ...
        'hero.cta.register': 'Register on Microsoft Reactor →',
        ...
        'reg.cta1': 'Register on Microsoft Reactor ↗',
        'reg.cta2': 'View Microsoft Reactor event page',
        'reg.note': 'Platform: Microsoft Reactor (developer.microsoft.com) · Limited seats, first-come first-served',
        'reg.official.badge': 'Official Microsoft Reactor event',
        'reg.official.link': 'View Reactor event page (event #27246) ↗',
