  ...
  const LANGS = {
    ...
    'zh-Hans': {
      ...
      dict: {
        ...
        'hero.title.line2.year': '2026',
        'hero.tagline': '一场由 <strong class="text-white">微软</strong>、<strong class="text-white">.NET 基金会</strong> 与 <strong class="text-white">中正大学 资工所</strong> 共同举办的技术交流活动。三位讲者、最新 Microsoft Build 开幕影片,并提供 Pizza 与饮料,一起认识 AI 与 微软/GitHub 技术的最新进展。',
        'hero.date.label': '日期',
        'hero.date.value': '2026 / 06 / 13',
        ...
        'about.body1': 'Microsoft Build 是微软每年针对开发者举办的技术大会。这次我们将 Build 带进校园,邀请 <strong class="text-white">微软工程师、微软 MVP、.NET 基金会、GitHub Star</strong> 走进中正大学,与学生及开发者分享 AI、Cloud、.NET 与开源的最新资讯。',
        ...
        'sched.4.badge1': '台积电副理',
        'sched.4.badge2': 'Microsoft MVP',
        'sched.4.badge3': 'GitHub Star',
        'sched.4.desc': '同时是台积电副理、微软 MVP,以及全球少数 GitHub Star 之一,分享在大型企业推动开源与 AI 的真实经验。',
        'sched.5.title': '结尾 & 纪念礼物',
        'sched.5.desc': '总结、Q&A 与合影,参与的每位伙伴都可获得一顶活动纪念帽 🧢,活动结束。',
        ...
        'sp.weihan.role': 'DNF Project Maintainer · Microsoft MVP',
        'sp.weihan.badge1': '.NET 基金会',
        'sp.weihan.badge2': 'Microsoft MVP',
        'sp.weihan.title': 'GitHub AI 训练专属知识库开发项目',
        'sp.weihan.desc': '分享如何在 GitHub 生态中打造专属知识库并用于 AI 训练,以及一个开源项目从规划、实作到部署的完整流程。',
        'sp.jeffrey.role': 'TSMC Deputy Manager · Microsoft MVP · GitHub Star',
        'sp.jeffrey.badge1': '台积电副理',
        'sp.jeffrey.badge2': 'Microsoft MVP',
        'sp.jeffrey.badge3': 'GitHub Star',
        'sp.jeffrey.desc': '身兼台积电副理、微软 MVP、与全球少数 GitHub Star 殊荣,于企业内推动开源、AI 与 DevOps 的实践者。',
